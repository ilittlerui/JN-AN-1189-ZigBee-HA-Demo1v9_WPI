...
#define ZPS_NODE_COLORDIMMABLELIGHT
...
/* Endpoints */
#define DIMMABLELIGHT_ZDO_ENDPOINT    (0)
#define DIMMABLELIGHT_LIGHT_ENDPOINT    (1)

/* Node 'OTAColorDimmableLightWithOccupancy' */

/* Endpoints */
#define OTACOLORDIMMABLELIGHTWITHOCCUPANCY_ZDO_ENDPOINT    (0)
#define OTACOLORDIMMABLELIGHTWITHOCCUPANCY_LIGHT_ENDPOINT    (1)

/* Node 'ColorTempTunableWhiteLight' */

/* Endpoints */
#define COLORTEMPTUNABLEWHITELIGHT_ZDO_ENDPOINT    (0)
#define COLORTEMPTUNABLEWHITELIGHT_LIGHT_ENDPOINT    (1)

/* Node 'ColorDimmableLight' */

/* Endpoints */
#define COLORDIMMABLELIGHT_ZDO_ENDPOINT    (0)
#define COLORDIMMABLELIGHT_LIGHT_ENDPOINT    (1)

/* Node 'OTAServer' */

/* Endpoints */
#define OTASERVER_ZDO_ENDPOINT    (0)
#define OTASERVER_EP1_ENDPOINT    (1)
#define OTASERVER_OTASERVEREP_ENDPOINT    (2)

/* Node 'DimmerSwitch' */

/* Endpoints */
#define DIMMERSWITCH_ZDO_ENDPOINT    (0)
#define DIMMERSWITCH_SWITCH_ENDPOINT    (1)

/* Node 'ColorDimmerSwitch' */

/* Endpoints */
#define COLORDIMMERSWITCH_ZDO_ENDPOINT    (0)
#define COLORDIMMERSWITCH_SWITCH_ENDPOINT    (1)
...
/* Endpoints */
#define REMOTECONTROL_ZDO_ENDPOINT    (0)
#define REMOTECONTROL_SWITCH_ENDPOINT    (1)
